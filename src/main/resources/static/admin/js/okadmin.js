layui.use(['element', 'layer'], function () {
    ...
    $(".layui-footer button").click(function () {
        layer.tab({
            ...
            tab: [{
                title: "支付宝",
                content: "<img src='/admin/images/zfb.jpg' width='200' height='300' style='margin-left: 60px'>"
            }, {
                title: "微信",
                content: "<img src='/admin/images/wx.jpg' width='200' height='300' style='margin-left: 60px'>"
            }]
        });
    });
